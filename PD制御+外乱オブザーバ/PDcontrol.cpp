...
int main(){
	...
	const double Dl = 0.3;//粘性摩擦係数
	const double Kl = 0.0;//弾性係数
	...
	do{
		...
		*/
		...
		if(DisplayCount == 0 || DisplayCount == (int)(1/Ts)) {
			...
			std::cout << "Theta reference      : " << Thout      << std::endl; //角度応答
